...
def sandbox_settings(tmp_path: Path) -> Settings:
    ...
    return Settings(
        ...
        delegation_max_units=5,
        delegation_max_unit_tool_calls=3,
        delegation_max_unit_model_turns=3,
        delegation_max_retries=0,
        retrieval_benchmark_top_k=3,
        retrieval_benchmark_min_precision_at_k=0.9,
        retrieval_benchmark_min_recall_at_k=0.9,
        retrieval_benchmark_max_mean_latency_ms=250.0,
        retrieval_benchmark_max_peak_memory_bytes=10_000_000,
